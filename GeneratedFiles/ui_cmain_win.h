...
public:
    ...
    void setupUi(QMainWindow *CMainWin)
    {
        ...
        action_save = new QAction(CMainWin);
        ...
        menu_3->addAction(action_object);
        menu_3->addAction(action_asset);
        menu_3->addAction(action_hierarchy);
        menu_3->addAction(action_property);
        menu_3->addAction(action_game);
        menu_3->addAction(action_anime);
        ...
        mainToolBar->addAction(action_20);
    ...
    {
        CMainWin->setWindowTitle(QApplication::translate("CMainWin", "YGGDRASIL", 0));
        ...
        action_save->setText(QApplication::translate("CMainWin", "    \344\277\235\345\255\230\345\267\245\347\250\213  ", 0));
